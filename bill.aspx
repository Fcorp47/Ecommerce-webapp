<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bill.aspx.cs" Inherits="AUshop.bill" %>
...
<a href="index.aspx">home</a><br/>
    <a href="yourorders.aspx">orders</a>
...
<body>
    ...
    <div class="container">
        ...
        <div class="body-section">
            <center> <div class="check"><i class="fa fa-check" aria-hidden="true"></i></div>ORDER PLACED SUCCESSFULLY</center>
         <h2 class="heading">ORDER ID:  <asp:Label ID="Label1" runat="server" Text="Label"></asp:Label> </h2><br />
            <h2 class="heading">ORDER Placed:  <asp:Label ID="Label3" runat="server" Text="Label"></asp:Label> </h2>
