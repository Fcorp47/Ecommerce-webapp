<%@ Page Title="" Language="C#" MasterPageFile="~/masterf.Master" AutoEventWireup="true" CodeBehind="invoice.aspx.cs" Inherits="AUshop.orederinvoice" %>
    ...
    <div class="container">
        ...
        <div class="body-section">
            ...
            <div class="row">
                ...
                <div class="col-6">
                    <h2 class="heading">ORDER ID: <%#Eval("OID") %></h2>
                  
                 <h2> <p class="sub-heading">Full Name: <%#Eval("cname") %></p> </h2>
        ...
        <div class="body-section">
          ...
          <asp:DataList ID="DataList1" runat="server">
            ...
            <br>
            <?php
                 	$c=mysqli_query($con,"select * from tblorder where OID='$oid'");
                 	$r=mysqli_fetch_assoc($c);
                 	?>
           <center> <h3 class="heading">Total Amount: <?php echo $r['Total'] ?> /-</h3>
            </center><h3 class="heading">Payment Status: Paid</h3>
            <h3 class="heading">Payment Mode: <?php echo $r['Mode'] ?></h3>
        </div>
