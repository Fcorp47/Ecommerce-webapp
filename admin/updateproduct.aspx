<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin.Master" AutoEventWireup="true" CodeBehind="updateproduct.aspx.cs" Inherits="AUshop.admin.updateproduct" %>
             ...
             if ((x >= 48 && x <= 57))
                 ...
                 return false;
                           ...
                           <div class="form-group">
                             ...
                             <asp:DropDownList ID="subcategory_list" required="" CssClass="form-control" runat="server" AutoPostBack="True">
                           ...
                           <div class="form-group">
                              ...
                              <asp:TextBox ID="txtpname" class="form-control"  placeholder="Enter Product name" CssClass="form-control" runat="server"></asp:TextBox>
                           ...
                           <div class="form-group">
                            ...
                            <asp:TextBox ID="txtspec"  class="form-control" placeholder="Enter Specifications" CssClass="form-control" runat="server"></asp:TextBox>
                           </div>


                          <div class="form-group">
                              <label class="form-control-label">Detail Description: </label>
                               <asp:TextBox ID="txtdetailspec"  class="form-control"  placeholder="Enter Detail Description" CssClass="form-control" runat="server"></asp:TextBox>
                              </div>
                           ...
                           <div class="form-group">
                              <label class="form-control-label">Price: </label>
                               <asp:TextBox ID="txtprice" onkeypress='return restrictAlphabets(event)'  class="form-control"  placeholder="Enter Price" CssClass="form-control" runat="server"></asp:TextBox>
                           </div>
